          ...
          <div className="card">
            <div className='card-header bg-dark p-3'>
              <div className='card-header-flex'>
                <h5 className='text-white m-0'>Cart Calcutation{carts.length > 0 ? `(${carts.length})` : ""}</h5>
                {
                  ...
                  <table className='table cart-table mb-0 table-responsive-sm'>
                    <thead>
                      <tr>
                        ...
                        <th>Price  </th>
                        <th>Qty  </th>
                        <th className='text-right'><span id='amount'>Total Amount </span> </th>
                      </tr>
                    </thead>
                    <tbody>
                      {
                          ...
                          return (
                            <>
                              <tr>
                                ...
                                <td><div className='product-img'><p>{data.dish} </p></div></td>
